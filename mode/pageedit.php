...
if ($_POST['Submit']) {
	...
	$update = "UPDATE blg_pages SET title = '$nameE', message = '$contE', privacy = $prE WHERE id = ".$aid;
	...
	$sql = "SELECT * FROM blg_pages WHERE id = ".$aid;
...
<div id='BlogTitle'><input type='text' name='Name' value='".$ptitle."'></div><br />
<div id='BlogBody'>";
include ("module/textbuttons.php");

echo "<textarea name='Content' id='message' rows='40' cols='160' wrap='hard'>".$pbody."</textarea><br />
<select name='Privacy'>
